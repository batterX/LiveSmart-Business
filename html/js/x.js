...
function mainLoop() {
	...
	$.get({
		...
		success: (json) => {
			...
			if(json_has("1041", "1")) $("#1041_1").html(round(json_get("1041", "1") * 0.01, 1));
			if(json_has("1042", "1")) $("#1042_1").html(round(json_get("1042", "1") * 0.01, 1));

			if(json_has("1057", "1")) $("#1057_1").html(round(json_get("1057", "1") * 0.01, 1));
			if(json_has("1058", "1")) $("#1058_1").html(round(json_get("1058", "1") * 0.01, 1));

			if(json_has("1073", "1")) $("#1073_1").html(round(json_get("1073", "1") * 1   , 1));
