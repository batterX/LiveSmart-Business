...
function performUpdate() {
	...
	$.get({
		...
		success: () => {
			...
			$.get({
				url: "https://raw.githubusercontent.com/batterX/LiveSmart-Business/master/version.txt",
				dataType: "text",
				cache: false,
				error: () => {
					$("#notif").removeClass("loading error success").addClass("error");
...
function showUpdateProgress() {
	$.get({
		url: "https://raw.githubusercontent.com/batterX/LiveSmart-Business/master/size.txt",
		dataType: "text",
		cache: false,
		error: () => {
